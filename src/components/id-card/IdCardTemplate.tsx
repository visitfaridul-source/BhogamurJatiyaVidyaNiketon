  ...
  return (
    ...
    >
      ...
      <div className="mb-[12mm] w-full px-3 flex justify-between items-end relative z-20 shrink-0 mt-auto">
        <div className="text-left flex flex-col justify-end pb-[0px]">
        ...
        <div className="text-right flex flex-col items-end pt-1 pb-[4px]">
          <div className="flex flex-col items-center">
            ...
            <div className="w-[18mm] h-[1.5px] bg-white mb-[2px]"></div>
            <p className="text-[8px] uppercase font-bold text-white tracking-wider text-center">
              Principal
            </p>
          </div>
        </div>
      ...
      {/* Bottom Bar */}
      <div
        className="absolute bottom-0 left-0 right-0 h-[22mm] w-full overflow-hidden shrink-0"
